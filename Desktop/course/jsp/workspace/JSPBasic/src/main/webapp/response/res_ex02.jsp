...
<style>
	...
	.form-btn {width : 100%; box-sizing : border-box; padding : 10px; background-color : green; 
...
<body>
	...
	<!-- class속성과 css속성 -->
	<!-- 
		css에는 html을 꾸미는 작업입니다. 인라인시트, 내부스타일시트, 외부스타일시트 방법이 있다
		내부스타일시트는 head태그에 style태그를 이용해서 css문법을 기술하고 그 태그의 선택자 개념을 이용해 디자인을 적용해주는 방법 
	 -->
